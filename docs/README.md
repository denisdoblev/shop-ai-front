...
- `/`, `/explore` y `/compare` usan catálogo real dentro de la carcasa con sidebar; `/assistant`, `/saved` y `/history` conservan sus estados actuales. La administración de catálogo está integrada con el backend.
